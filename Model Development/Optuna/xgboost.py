!pip install optuna pyarrow xgboost
...
final_sample_weights = compute_sample_weight(class_weight="balanced", y=y_final)
...
final_model.fit(X_final.values, y_final, sample_weight=final_sample_weights, verbose=False)

probs = final_model.predict_proba(X_test.values)
